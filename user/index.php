...
<body>
  ...
  <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between ">
    ...
    <a href="user-order-UI.php" class="book-a-table-btn scrollto d-none d-lg-flex">Order now</a>
  </div>
</header><!-- End Header -->
  ...
  <section id="hero" class="d-flex align-items-center">
    <div class="container position-relative text-center text-lg-start" data-aos="zoom-in" data-aos-delay="100">
      <div class="row">
        <div class="col-lg-4">
          <h1>Cra<span>ve</span></h1>
          <h2>Order now we deliver</h2>
  ...
  <main id="main">
    ...
    <section id="menu" class="menu section-bg">
      <div class="container" data-aos="fade-up">
        ...
        <div class="row menu-container d-flex justify-content-center" data-aos="fade-up" data-aos-delay="200">

          <div class="col-lg-4 menu-item filter-samsung text-center">
            <img src="assets/img/menu/img-1.png" class="" alt="">
            <div class="menu-content">
              <a href="#">Samsung A8 2022</a>
            </div>
          </div>

          <div class="col-lg-4 menu-item filter-oppo text-center">
            <img src="assets/img/menu/img-2.png" class="" alt="">
            <div class="menu-content">
              <a href="#">Oppo A7 2021</a>
            </div>
          </div>

          <div class="col-lg-4 menu-item filter-apple text-center">
            <img src="assets/img/menu/img-3.png" class="" alt="">
            <div class="menu-content">
              <a href="#">iPhone 14 Pro Max</a>
            </div>
          </div>

          <div class="col-lg-4 menu-item filter-xiaomi text-center">
            <img src="assets/img/menu/img-4.png" class="" alt="">
            <div class="menu-content">
              <a href="#">Poco F2 Pro</a>
            </div>
            </div>
           
          <div class="col-lg-4 menu-item filter-apple text-center">
            <img src="assets/img/menu/img-5.png" class="" alt="">
            <div class="menu-content">
              <a href="#">iPhone 12</a>
            </div>
            </div>

            <div class="col-lg-4 menu-item filter-vivo text-center">
            <img src="assets/img/menu/img-8.png" class="" alt="">
            <div class="menu-content">
              <a href="#">Vivo V21E</a>
            </div>
            </div>

            <div class="col-lg-4 menu-item filter-lenovo text-center">
            <img src="assets/img/menu/img-7.png" class="" alt="">
            <div class="menu-content">
              <a href="#">Lenovo 2009</a>
            </div>
            </div>
   ...
   <!-- <section id="events" class="events">
    ...
    <section id="contact" class="contact">
      ...
      <div data-aos="fade-up">
        <iframe style="border:0; width: 100%; height: 350px;" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3925.591846881394!2d123.89344197490084!3d10.294432889826549!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x33a99bfcc60d650d%3A0x5ee73506c68dd233!2sCebu%20Eastern%20College!5e0!3m2!1sen!2sph!4v1684891366683!5m2!1sen!2sph" frameborder="0" allowfullscreen></iframe>
      </div>
          ...
          <div class="col-lg-4">
            <div class="info">
              <div class="address">
                ...
                <h4>Location:</h4>
                <p>Cebu Eastern College, Cebu City, Philippines</p>
              </div>
